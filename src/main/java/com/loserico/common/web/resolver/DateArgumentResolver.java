package com.loserico.common.web.resolver;

import com.loserico.common.web.utils.DateUtils;
...
public class DateArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest,
		...
		if (matches(ISO_DATETIME_PATTERN, value)) {
			result = DateUtils.parse(value, DateUtils.FMT_ISO_DATE_TIME);
